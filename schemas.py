...
class UserBase(BaseModel): # this defines what is common to all user related data.
    username: str

class UserCreate(UserBase): # this is where the users plain password lives for a split second
    password: str

class UserPublic(UserBase): # this is what you send back to the user when they ask who ami 
